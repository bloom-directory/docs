...
- **Clear safety boundary.** Reads are broadly available; value-moving actions still require the applicable policy, approval, signing, and confirmation gates. Broadcasting is available on every configured chain; Solana submissions also require a verified genesis pin.
