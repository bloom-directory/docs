...
Status badges reflect the implementation on Bloom `master`: **Shipped** is available today, **Partial** has meaningful gaps or an active migration, and **Planned** is not available end to end yet.
