...
Solana supports native SOL balance reads and native SOL transfers through numbered HD wallet accounts. Solana mainnet broadcasting is disabled by default; enable it only with a pinned, correct cluster genesis hash.
