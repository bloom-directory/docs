...
Bloom is for people who already work with AI agents and want those agents to touch crypto without handling private keys. Bloom provides an agent-readable filesystem for wallet and chain workflows.
