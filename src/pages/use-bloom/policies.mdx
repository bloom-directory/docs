...
- do not stage or confirm public-chain transactions until you deliberately test the workflow.
...
Because policies are represented in files, your agent can inspect and explain them. The complete canonical source is `wallets/<wallet>/policy.json`.
