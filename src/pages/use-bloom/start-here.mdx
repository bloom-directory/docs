...
:::warning
Bloom walletFS is alpha software. It is experimental and unaudited. Mainnet broadcasting is off by default; you have to deliberately enable it. Start on a local or test network, use small amounts, and treat the system like early software.
:::
