...
- **Broadcasting is available on every configured chain.** Configuration is not an approval boundary: policy, approval, confirmation, and Signer checks remain mandatory. Solana transactions also require a verified genesis pin.
